  ...
  return (
    <main className="shell">
      <header className="brandRow">
        ...
        <div className="vbadge">V0.4.1</div>
      </header>
      ...
      {!analysis ? (
        <section className="card heroCard">
          ...
          <p className="privacy">🔒 Ekran görüntüsü gönderilmeden önce küçültülür ve yeniden kodlanır. V0.4.1 kendi veritabanımızda analiz içeriği saklamaz.</p>
        </section>
      ) : (
          ...
          {analysis.meta && (
            <details className="metricsBox">
              ...
              <div className="metricsGrid">
                <span><b>{analysis.meta.model || "—"}</b><small>Model</small></span>
              ...
              <p>Bu maliyet tahmini model token ücretleri ve web arama çağrısı ücretine göre hesaplanır; faturalandırma ekranındaki tutar nihai kaynaktır.</p>
            </details>
          )}
      ...
      <footer>GüvenCheck · Erken erişim V0.4.1 · <a href="/lab" style={{color:"inherit"}}>Lab</a></footer>
    </main>
  );
}
