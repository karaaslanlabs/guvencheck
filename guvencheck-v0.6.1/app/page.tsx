    ...
    <main className="shell">
      ...
      {!analysis ? (
        <section className="card heroCard">
          ...
          <p className="privacy">🔒 Ekran görüntüsü gönderilmeden önce küçültülür ve yeniden kodlanır. V0.6.1 kendi veritabanımızda analiz içeriği saklamaz. <a href="/privacy">Gizlilik özeti</a></p>
        </section>
      ) : (
      ...
      <footer>GüvenCheck · Kapalı Beta V0.6.1 · <a href="/privacy" style={{color:"inherit"}}>Gizlilik</a></footer>
    </main>
  );
}
