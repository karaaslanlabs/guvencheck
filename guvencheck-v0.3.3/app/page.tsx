  ...
  return (
    <main className="shell">
      <header className="brandRow">
        ...
        <div className="vbadge">V0.3.3</div>
      </header>
      ...
      {!analysis ? (
        <section className="card heroCard">
          ...
          <p className="privacy">🔒 Ekran görüntüsü gönderilmeden önce küçültülür ve yeniden kodlanır. V0.3.3 kendi veritabanımızda analiz içeriği saklamaz.</p>
        </section>
      ) : (
      ...
      <footer>GüvenCheck · Erken erişim V0.3.3</footer>
    </main>
  );
}
