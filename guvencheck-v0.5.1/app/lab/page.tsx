...
export default function LabPage() {
  ...
  return <main className="labShell">
    <header className="brandRow"><div className="logo">G</div><div><div className="brand">GüvenCheck Lab</div><div className="tagline">V0.5.1.0 — Terra / Luna A/B benchmark</div></div><a className="labBack" href="/">Uygulamaya dön</a></header>
