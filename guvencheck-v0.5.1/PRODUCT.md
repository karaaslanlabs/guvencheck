# GüvenCheck V0.5.1 — ilk hibrit üretim mimarisi

## Benchmark kararı

Ölçülen testlerde Luna, kritik dolandırıcılık vakalarını kaçırmadan Terra'dan belirgin şekilde daha düşük maliyet ve daha düşük gecikme sundu. Sapmalar ağırlıklı olarak belirsiz 25–75 skor bandında oluştu. Bu nedenle V0.5.1 tek-model seçimi yerine yönlendirme kullanır.
