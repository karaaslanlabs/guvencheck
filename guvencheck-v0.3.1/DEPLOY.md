# GüvenCheck V0.3.1 — Kod bilmeden yayınlama
...
7. `guvencheck-v0.3.1` klasörünün İÇİNDEKİ tüm dosya ve klasörleri yükleme alanına sürükle. Repo kökünde `package.json`, `app`, `public` görünmeli; fazladan `guvencheck-v0.3.1/` üst klasörü olmamalı.
...
2. Şuna benzer yanıt beklenir:
   `{"ok":true,"aiConfigured":true,"version":"0.3.1"}`
...
## İlk deploy sonrası
Canlı Vercel adresini ChatGPT'ye gönder. Sonraki adımda canlı ürünü birlikte test edip hataları V0.3.1.1'de düzelteceğiz.
