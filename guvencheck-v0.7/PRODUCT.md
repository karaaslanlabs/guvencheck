# GüvenCheck — V0.6.1 Beta Product Notes
...
## Kanıtlanan erken sinyaller
- Sentetik mesaj benchmarklarında kritik kaçırma gözlenmedi.
- Luna maliyet avantajı sağlarken Terra gri/kritik vakalarda kalite valfi olarak kullanılıyor.
