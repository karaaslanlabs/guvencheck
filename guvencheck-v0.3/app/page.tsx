    ...
    <main className="shell">
      ...
      {!analysis ? (
        <section className="card heroCard">
          ...
          <p className="privacy">🔒 Ekran görüntüsü gönderilmeden önce küçültülür ve yeniden kodlanır. V0.2 kendi veritabanımızda analiz içeriği saklamaz.</p>
        </section>
      ) : (
      ...
      <footer>GüvenCheck · Erken erişim V0.2</footer>
    </main>
  );
}
