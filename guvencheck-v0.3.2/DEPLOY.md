# GüvenCheck V0.3.2 — Kod bilmeden yayınlama
...
7. `guvencheck-v0.3.2` klasörünün İÇİNDEKİ tüm dosya ve klasörleri yükleme alanına sürükle. Repo kökünde `package.json`, `app`, `public` görünmeli; fazladan `guvencheck-v0.3.2/` üst klasörü olmamalı.
...
## İlk deploy sonrası
Canlı Vercel adresini ChatGPT'ye gönder. Sonraki adımda canlı ürünü birlikte test edip hataları V0.3.2.1'de düzelteceğiz.
