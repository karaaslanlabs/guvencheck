...
export default function Home() {
  ...
  async function analyze() {
    ...
    try {
      ...
      if (!response.ok) throw new Error(data.error || "Analiz sırasında hata oluştu.");
      setAnalysis(data);
  ...
  return (
    <main className="shell">
      <header className="brandRow">
        ...
        <div className="vbadge">V0.5.0</div>
      </header>
      ...
      {!analysis ? (
        <section className="card heroCard">
          ...
          <p className="privacy">🔒 Ekran görüntüsü gönderilmeden önce küçültülür ve yeniden kodlanır. V0.5.0 kendi veritabanımızda analiz içeriği saklamaz.</p>
        </section>
      ) : (
      ...
      <footer>GüvenCheck · Erken erişim V0.5.0 · <a href="/lab" style={{color:"inherit"}}>Lab</a></footer>
    </main>
  );
}
