# GüvenCheck V0.5 — ilk hibrit üretim mimarisi

## Benchmark kararı

Ölçülen testlerde Luna, kritik dolandırıcılık vakalarını kaçırmadan Terra'dan belirgin şekilde daha düşük maliyet ve daha düşük gecikme sundu. Sapmalar ağırlıklı olarak belirsiz 25–75 skor bandında oluştu. Bu nedenle V0.5 tek-model seçimi yerine yönlendirme kullanır.
