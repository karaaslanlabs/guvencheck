    ...
    <main className="shell">
      ...
      {!analysis ? (
        <section className="card heroCard">
          ...
          <p className="privacy">🔒 Ekran görüntüsü gönderilmeden önce küçültülür ve yeniden kodlanır. V0.4 kendi veritabanımızda analiz içeriği saklamaz.</p>
        </section>
      ) : (
      ...
      <footer>GüvenCheck · Erken erişim V0.4 · <a href="/lab" style={{color:"inherit"}}>Lab</a></footer>
    </main>
  );
}
