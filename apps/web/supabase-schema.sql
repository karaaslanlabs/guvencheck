...
create table if not exists public.beta_events (
  ...
  event_type text not null check (event_type in ('page_view','analysis_started','analysis_completed','analysis_error','share_clicked','privacy_view','analysis_feedback','protection_save_intent','protection_saved','protection_removed','protection_status_view','protection_event_useful','repeat_protection','deep_verification_eligible','deep_verification_interest')),
  session_id text,
