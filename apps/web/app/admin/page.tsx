  ...
  return <main className="adminShell">
    ...
    <section className="adminPanel">
      ...
      <div className="adminPanels adminPanelsFour">
        <div className="adminPanel"><h2>Protection ödeme ilgisi</h2><div className="adminReason"><span>Evet</span><b>{m3.paymentInterest.yes || 0}</b></div><div className="adminReason"><span>Belki</span><b>{m3.paymentInterest.maybe || 0}</b></div><div className="adminReason"><span>Hayır</span><b>{m3.paymentInterest.no || 0}</b></div></div>
        <div className="adminPanel"><h2>Payer rolü (M3.2 legacy)</h2><div className="adminReason"><span>Kendim</span><b>{m3.payerRoles.self || 0}</b></div><div className="adminReason"><span>Aile</span><b>{m3.payerRoles.family || 0}</b></div><div className="adminReason"><span>İş</span><b>{m3.payerRoles.work || 0}</b></div></div>
