...
const allowedEvents = new Set(["page_view","analysis_started","analysis_completed","analysis_error","share_clicked","privacy_view","protection_save_intent","protection_saved","protection_removed","protection_status_view"]);
