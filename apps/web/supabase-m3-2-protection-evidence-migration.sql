-- GüvenCheck M3.2 protection evidence delta.
...
alter table public.beta_events add constraint beta_events_event_type_check check (
  event_type in (
    ...
    'protection_candidate_eligible','protection_action_due_view','protection_save_intent','protection_saved','protection_removed','protection_status_view','protection_event_useful','repeat_protection',
