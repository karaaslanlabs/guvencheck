...
4. Supabase production schema değişiklikleri yalnız ayrı migration gate'inde uygulanır; önce yedek/current schema doğrulanır. Mevcut `m3_2_evidence_activation` uygulanmış production için `supabase-m3-2-protection-eligibility-migration.sql` delta'sı deploy öncesi ayrıca uygulanmalıdır.
